...
const getOrderId = async (req, res) => {
    try {
        ...
        var options = {
            amount: req.body.amount * 100, currency: "INR", receipt: "TXN" + Date.now(), notes: {
                key1: req.body.name,
                key2: req.body.email,
...
const paymentCallBack = async (req, res) => {
    ...
    try {
        ...
        console.log(error.message);
        return res.redirect('http://localhost:3000/groups')
    }
...
module.exports = {
    getOrderId, paymentCallBack, paymentCancel
}